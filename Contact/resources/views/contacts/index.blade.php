...
<div class="container mx-auto p-4 space-y-6">
    ...
    <div class="flex gap-4 justify-between items-center bg-white p-4 rounded-xl shadow-sm border">
        <input type="text" id="search" class="py-2 px-4 w-full max-w-sm border rounded-lg" placeholder="Rechercher...">
        <button type="button" id="openModal" class="py-2 px-4 bg-blue-600 text-white rounded-lg">Ajouter Contact</button>
    </div>
