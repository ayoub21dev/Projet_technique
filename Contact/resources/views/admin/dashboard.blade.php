...
<div class="space-y-6" x-data="contactsManager()" x-init="init()">
    <div class="flex justify-between items-center">
        ...
        <div id="success-msg" class="text-green-600 font-medium h-6" x-text="successMessage"></div>
    </div>
    ...
    <div class="border border-slate-200 rounded-lg overflow-hidden bg-white shadow-sm">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody id="contacts-table-body" x-ref="contactsTableBody" class="divide-y divide-gray-200">
    ...
    <div id="pagination-container" x-ref="paginationContainer" class="mt-4 flex justify-center">
